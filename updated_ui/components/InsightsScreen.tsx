...
export function InsightsScreen({ onBack, language }: InsightsScreenProps) {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-teal-50 to-blue-50 p-6 relative">
      {/* Header */}
      <div className="flex justify-between items-center mb-6">
        <div className="flex items-center gap-3">
          ...
          <p className="text-teal-900">{t.insights}</p>
        </div>
        <button
          onClick={onBack}
      ...
      <div className="bg-gradient-to-br from-teal-400 to-cyan-500 rounded-3xl p-6 mb-6 shadow-lg">
        <div className="flex items-center gap-2 mb-2">
          ...
          <p className="text-white">{t.savings}</p>
        </div>
        <p className="text-white mb-2">₹ 8,450</p>
        <div className="flex items-center gap-2 bg-white/20 backdrop-blur px-4 py-2 rounded-full inline-flex">
          <div className="w-2 h-2 bg-white rounded-full"></div>
          <span className="text-white text-sm">↑ 12% from last month</span>
        </div>
      </div>
      ...
      <div className="bg-white rounded-3xl p-6 mb-6 shadow-lg">
        <div className="flex items-center gap-2 mb-4">
          ...
          <p className="text-gray-900">{t.spending}</p>
        </div>
        
        <div className="mb-4">
          <p className="text-teal-600 text-sm">{t.total}</p>
          <p className="text-gray-900">₹ 12,769.50</p>
        </div>
        ...
        <div className="space-y-4">
          ...
          <div className="bg-gradient-to-r from-blue-50 to-blue-100 rounded-2xl p-4">
            <div className="flex items-center gap-3 mb-3">
              ...
              <div className="flex-1">
                <p className="text-gray-900 text-sm mb-1">{t.essentials}</p>
                <div className="flex justify-between items-center">
                  ...
                  <p className="text-gray-900 text-sm">₹ 6,500</p>
                </div>
              </div>
            </div>
          ...
          <div className="bg-gradient-to-r from-purple-50 to-purple-100 rounded-2xl p-4">
            <div className="flex items-center gap-3 mb-3">
              ...
              <div className="flex-1">
                <p className="text-gray-900 text-sm mb-1">{t.entertainment}</p>
                <div className="flex justify-between items-center">
                  <div className="flex-1 bg-purple-200 rounded-full h-2 mr-3">
                    <div className="bg-purple-500 h-2 rounded-full" style={{ width: '25%' }}></div>
                  </div>
                  <p className="text-gray-900 text-sm">₹ 3,200</p>
                </div>
              </div>
            </div>
          ...
          {/* Shopping */}
          <div className="bg-gradient-to-r from-rose-50 to-rose-100 rounded-2xl p-4">
            <div className="flex items-center gap-3 mb-3">
              <div className="w-10 h-10 bg-rose-500 rounded-full flex items-center justify-center flex-shrink-0">
                <ShoppingBag className="w-5 h-5 text-white" />
              </div>
              <div className="flex-1">
                <p className="text-gray-900 text-sm mb-1">{t.shopping}</p>
                <div className="flex justify-between items-center">
                  <div className="flex-1 bg-rose-200 rounded-full h-2 mr-3">
                    <div className="bg-rose-500 h-2 rounded-full" style={{ width: '16%' }}></div>
                  </div>
                  <p className="text-gray-900 text-sm">₹ 2,069.50</p>
                </div>
              </div>
            </div>
          ...
          {/* Others */}
          <div className="bg-gradient-to-r from-teal-50 to-teal-100 rounded-2xl p-4">
            <div className="flex items-center gap-3 mb-3">
              <div className="w-10 h-10 bg-teal-500 rounded-full flex items-center justify-center flex-shrink-0">
                <Zap className="w-5 h-5 text-white" />
              </div>
              <div className="flex-1">
                <p className="text-gray-900 text-sm mb-1">{t.others}</p>
                <div className="flex justify-between items-center">
                  <div className="flex-1 bg-teal-200 rounded-full h-2 mr-3">
                    <div className="bg-teal-500 h-2 rounded-full" style={{ width: '8%' }}></div>
                  </div>
                  <p className="text-gray-900 text-sm">₹ 1,000</p>
                </div>
              </div>
            </div>
      ...
      {/* Target Savings Goal */}
      <div className="bg-gradient-to-br from-amber-400 to-orange-400 rounded-3xl p-6 shadow-lg">
        <div className="flex items-center gap-2 mb-4">
          <div className="w-10 h-10 bg-white/30 backdrop-blur rounded-full flex items-center justify-center">
        ...
        <div className="space-y-4">
          ...
          <div className="bg-white/20 backdrop-blur rounded-full p-1">
            <div className="w-full bg-white/30 rounded-full h-4">
              ...
              >
                <span className="text-amber-600 text-xs">65%</span>
              </div>
            </div>
          </div>
          
          <div className="flex justify-between items-center">
            <p className="text-white text-sm">{t.keepGoing}</p>
            <p className="text-white text-sm">₹ 17,500 {t.toGo}</p>
          </div>
        </div>
      </div>
    </div>
