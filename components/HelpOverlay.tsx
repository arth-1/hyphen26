    ...
    <div className="absolute inset-0 bg-black/80 backdrop-blur-sm z-50 flex items-center justify-center p-6 animate-in fade-in duration-300">
      <div className="bg-white rounded-3xl p-6 max-w-md w-full max-h-[90vh] overflow-y-auto">
        ...
        <div className="flex justify-between items-center mb-6">
          <p className="text-gray-900 text-xl font-semibold">Help & Support</p>
          <button
            onClick={onClose}
        ...
        <div className="space-y-4">
          {/* Video Tutorials */}
          <button className="w-full bg-linear-to-br from-rose-400 to-pink-500 rounded-2xl p-6 flex items-start gap-4 hover:shadow-lg transition-all active:scale-95">
            ...
            <div className="text-left flex-1">
              <p className="text-white font-semibold mb-1">Video Tutorials</p>
          ...
          {/* Audio Guide */}
          <button className="w-full bg-linear-to-br from-purple-400 to-pink-500 rounded-2xl p-6 flex items-start gap-4 hover:shadow-lg transition-all active:scale-95">
            <div className="w-16 h-16 bg-white rounded-full flex items-center justify-center shrink-0">
              <Headphones className="w-8 h-8 text-purple-500" />
            </div>
            <div className="text-left flex-1">
              <p className="text-white font-semibold mb-1">Audio Guide</p>
          ...
          {/* Text Instructions */}
          <button className="w-full bg-linear-to-br from-blue-400 to-cyan-500 rounded-2xl p-6 flex items-start gap-4 hover:shadow-lg transition-all active:scale-95">
            <div className="w-16 h-16 bg-white rounded-full flex items-center justify-center shrink-0">
              <FileText className="w-8 h-8 text-blue-500" />
            </div>
            <div className="text-left flex-1">
              <p className="text-white font-semibold mb-1">Text Instructions</p>
          ...
          {/* Live Chat */}
          <button className="w-full bg-linear-to-br from-teal-400 to-cyan-500 rounded-2xl p-6 flex items-start gap-4 hover:shadow-lg transition-all active:scale-95">
            <div className="w-16 h-16 bg-white rounded-full flex items-center justify-center shrink-0 relative">
            ...
            <div className="text-left flex-1">
              <p className="text-white font-semibold mb-1">Live Chat Support</p>
        ...
        {/* Quick Tips */}
        <div className="mt-6 bg-linear-to-br from-amber-50 to-orange-50 rounded-2xl p-4 border-2 border-amber-200">
          <p className="text-amber-900 mb-3 text-sm font-semibold">Quick Tips</p>
        ...
        <div className="mt-4 text-center">
          ...
          <p className="text-teal-600 text-sm font-semibold">Call: 1800-123-4567</p>
        </div>
      </div>
    </div>
  );
